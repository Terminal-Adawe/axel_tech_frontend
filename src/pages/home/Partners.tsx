							...
							<div className="d-flex justify-content-center">
								<div className="partners-board">
									<div className="row no-gutters" style={{height: '100%'}}>
										<div className="col-lg-2 col-sm-2 partner-box">
											<div className="centerDiv">PARTNERS</div>
										</div>
										<div className="col-lg-2 col-sm-2 partner-box">
											<div className="centerDiv">PARTNER 1</div>
										</div>
										<div className="col-lg-2 col-sm-2 partner-box">
											<div className="centerDiv">PARTNER 2</div>
										</div>
										<div className="col-lg-2 col-sm-2 partner-box">
											<div className="centerDiv">PARTNER 3</div>
										</div>
										<div className="col-lg-2 col-sm-2 partner-box">
											<div className="centerDiv">PARTNER 4</div>
										</div>
										<div className="col-lg-2 col-sm-2 partner-box">
											<div className="centerDiv">PARTNER 5</div>
										</div>
									</div>
								</div>
							</div>
